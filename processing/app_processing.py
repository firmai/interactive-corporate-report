...
for target_code in short_codes:
   ...
   # s_metrics_df = fm.s_metrics_df
    ...
    s_metrics_df = pd.DataFrame([["Sentiment", "E", "C", "S", "M", "A", "BA"],
                                 [target_code, new_frame[new_frame.index==target_code].round(1)["Employees"].values[0],
    ...
    overall_r_tick = overall_r[overall_r["ticker"]==target_code]
    ...
    dict_collect["Stakeholder Description"] = dict_info
