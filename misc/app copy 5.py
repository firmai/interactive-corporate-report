...
html.Div([  # page 5
        ...
        html.Div([  # subpage 2
            ...
            html.Div([
                ...
                html.Div(cb.info_layout_drop_downs, id='customer_bar'),

                html.Div(id='tab-output-customer'),

                html.Div(id='droll'),

                html.Div(html.H6(["Rot Analysis"]), id='droll_2'),
...
app.callback(
    dash.dependencies.Output('store_values', 'children'),
     ...
     dash.dependencies.Input('benchmark_code_info', 'value'),
     dash.dependencies.Input('target_location_info', 'value')])
def display_content( bench_location_inf,benchmark_code_inf,target_location_inf):

    print("I am adjusting")
    return json.dumps({"bench_location_info": bench_location_inf, "benchmark_code_info": benchmark_code_inf,
                          "target_location_info": target_location_inf})
