    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.H6('National',
                        className="gs-header gs-table-header padded", style={"margin-top": "0.6cm","text-align": "left"}),
        ...
        html.Div([
            ...
            html.H6('Food Categories',
                    className="gs-header gs-table-header padded", style={"margin-top": "0.6cm"}),

            html.Table(make_dash_table(mat["category"]), id="df2", style={"margin-top": "0.6cm"})
