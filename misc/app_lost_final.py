...
def display_content(hidden_dict ):
    ...
    benchmark_code_info_v = bench_code_dd
    target_location_info_v = target_location_small_dd
    ...
    fig_b = figures_dict_b[benchmark_code_info_v, closest["name"]]
    ...
    oi = oil.dict(fig_d,fig_b, fig_d_n, fig_b_n,target_code)
